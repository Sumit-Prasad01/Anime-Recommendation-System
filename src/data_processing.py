...
class DataProcessor:
    ...
    def filter_users(self, min_rating = 400):
        try:
            ...
            raise CustomException(f"Failed to filter users data", sys)
    ...
    def encode_decode_data(self):
        try:
            ...
            logger.info("Encoding and decoding done for users and anime.")

        except Exception as e:
            raise CustomException(f"Failed to encode and decode  data", sys)
    ...
    def save_artifacts(self):
        try:
            ...
            for name, data in artifacts.items():
                ...
                logger.info(f"{name} saved successfully in processed dir.")
            ...
            logger.info("All the training testing data as well as rating_df saved successfully.")

                
        except Exception as e:
            raise CustomException(f"Failed to save artifacts data", sys)
    ...
    def process_anime_data(self):
        try:
            ...
            raise CustomException(f"Failed to save anime and anime synopsis data", sys)
    ...
    def run(self):
        try:
            ...
            logger.info("Data processing pipeline ran esuccessfully.")
